...
export default function separatorPage() {
  return (
    <div>
      <Breadcrumb items={[{ label: "Components" }, { label: "separator" }]} />
      <ComponentHeader category="Components" title="separator" />
      <div className="bg-card p-16 rounded-lg">
        <div className="flex flex-col gap-16">
          <div className="flex flex-col gap-5">
            <h2 className="text-card-foreground">separator Component</h2>
